...
public interface AnswerRepository extends JpaRepository<Answer, Long> {
    ...
    @Query("SELECT a1.upVoteCount, a2.upVoteCount , a1.questionId FROM Answer a1 join Answer a2 ON a1.questionId = a2.questionId WHERE a1.answerId <> a2.questionId AND (a1.isAccepted IS TRUE AND a2.isAccepted is FALSE ) AND a2.upVoteCount > a1.upVoteCount")
